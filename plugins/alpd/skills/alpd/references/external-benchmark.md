...
`alpd_pipeline_*` tools are for the design pipeline, not this benchmark contract.
...
monomer confidence, hotspot coverage, or new ALPD predictions. Missing is unknown.
