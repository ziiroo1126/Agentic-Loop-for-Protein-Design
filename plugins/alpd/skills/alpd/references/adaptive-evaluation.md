...
`CLI` below means the existing `alpd` executable or:

```bash
python3 /path/to/skill/scripts/alpd.py --project-root /path/to/ALPD -- adaptive --help
```
...
New sessions use `alpd-adaptive-development-v2`, with code snapshots including the
