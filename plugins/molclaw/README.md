...
[adaptive workflow](skills/molclaw/references/adaptive-evaluation.md).
...
also supported host choices. The [setup reference](skills/molclaw/references/host-adapters.md)
...
Start with the [skill](skills/molclaw/SKILL.md),
...
is documented in the [CLI protocol](skills/molclaw/references/cli-and-protocol.md#full-design-pipeline).
...
were checked. See the [DSH verification record](skills/molclaw/references/deepseek-harness.md#verification-boundary)
